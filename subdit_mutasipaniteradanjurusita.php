...
error_reporting(0);
include("koneksi.php");
$_SESSION['pilihbagian'] = "subdit_mutasipaniteradanjurusita"; 
...
<div class="container">
	...
	<div class="content" >
			...
			<div class="judul label-success" style=" color:black;  border-style: initial;  border-radius: 0px 0px 0px 10px; width:100%; text-align:center;" > 
				<font face="verdana"><font size="5">Subdit Mutasi Panitera dan Jurusita</font></font>
					...
					<table  id="table1"  class=" table table-bordered table-striped   " >
						...
						?>
							<tr  align="center">
								...
								<td align="center">
								<a href="edit.php?kode=<?php echo $hasil["kode"];?>& noPeraturan=<?php echo $hasil["noPeraturan"];?>& data=<?php echo $hasil["file"]; ?>
								& tahun=<?php echo $hasil["tahun"];?> & tentang=<?php echo $hasil["tentang"];?>& status=<?php    //fungsi edit
								echo $hasil["status"];?>">
								<button class="btn btn-info glyphicon glyphicon-edit"> Edit</button></a>
								<a  href="hapus.php?kode=<?php echo $hasil["kode"];?> "onclick="return confirm('Hapus data ini?');   ">	<!-- "onclick="return confirm('Hapus data ini?');  untuk memunculkan popup pertanyaan -->
								<button class="btn btn-danger glyphicon glyphicon-trash"> Hapus</button></a>
								</td>

								<td><a href='upload/subdit_mutasipaniteradanjurusita/<?php echo $hasil["file"]; ?>'>
								<button class="btn btn-success glyphicon glyphicon-download-alt"> </button></a></td>
