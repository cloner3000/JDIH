...
error_reporting(0);
include("koneksi.php");
$_SESSION['pilihbagian'] = "subdit_bimbingandanmonitoring"; 
...
<div class="container">
	...
	<div class="content" >
			...
			<div class="judul label-success" style=" color:black;  border-style: initial;  border-radius: 0px 0px 0px 10px; width:100%; text-align:center;" > 
				<font face="verdana"><font size="5">Subdit Bimbingan dan Monitoring</font></font>
					...
					<table  id="table1"  class=" table table-bordered table-striped   " >
						...
						?>
							<tr  align="center">
								...
								<td><a href='upload/subdit_bimbingandanmonitoring/<?php echo $hasil["file"]; ?>'>
