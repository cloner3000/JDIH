...
$_SESSION['pilihbagian'] = "bagian_perencanaandankeuangan"; 
...
<div class="container">
	...
	<div class="content" >
			...
			<div class="judul label-success" style=" color:black;  border-style: initial;  border-radius: 0px 0px 0px 10px; width:100%; text-align:center;" > 
				<font face="verdana"><font size="5">Bagian Perencanaan dan Keuangan</font></font>
					...
					<table  id="table1"  class=" table table-bordered table-striped   " >
						...
						?>
							<tr  align="center">
								...
								<td><a href='upload/bagian_perencanaandankeuangan/<?php echo $hasil["file"]; ?>'>
